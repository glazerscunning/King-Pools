        ...
        { ?>
            <script type="text/javascript">
                jQuery(document).ready(function() {
                    jQuery('<option>').val('verify_cheques').text('<?php _e('Verify check payment', 'nggallery')?>').appendTo("select[name='action']");
                    jQuery('<option>').val('verify_cheques').text('<?php _e('Verify check payment', 'nggallery')?>').appendTo("select[name='action2']");
                });
            </script>
        <?php }
    }
